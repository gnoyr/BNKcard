...
-- ① 모바일 현금카드 이용약관
INSERT INTO TERMS_MASTERS (terms_master_id, terms_type, title, description, created_at)
VALUES (SEQ_TERMS_MASTERS.NEXTVAL, 'CARD_SERVICE', '모바일 현금카드 이용약관', '모바일 현금카드 이용약관 개정 전문 (2025.04.07)', SYSTIMESTAMP);

-- ② 여신전문금융회사 전자금융거래 기본약관
INSERT INTO TERMS_MASTERS (terms_master_id, terms_type, title, description, created_at)
VALUES (SEQ_TERMS_MASTERS.NEXTVAL, 'CARD_SERVICE', '여신전문금융회사 전자금융거래 기본약관', '여신전문금융회사 표준 전자금융거래 기본약관 전문', SYSTIMESTAMP);

-- ③ 온누리전자상품권 약관
INSERT INTO TERMS_MASTERS (terms_master_id, terms_type, title, description, created_at)
VALUES (SEQ_TERMS_MASTERS.NEXTVAL, 'CARD_SERVICE', '온누리전자상품권 약관', '온누리전자상품권 약관 (2016.10.30)', SYSTIMESTAMP);

-- ④ 현금카드 약관
INSERT INTO TERMS_MASTERS (terms_master_id, terms_type, title, description, created_at)
VALUES (SEQ_TERMS_MASTERS.NEXTVAL, 'CARD_SERVICE', '현금카드 약관', '현금카드 이용약관 전문', SYSTIMESTAMP);

-- ⑤ 현금카드 가맹점 약관
INSERT INTO TERMS_MASTERS (terms_master_id, terms_type, title, description, created_at)
VALUES (SEQ_TERMS_MASTERS.NEXTVAL, 'CARD_SERVICE', '현금카드 가맹점 약관', '현금카드 가맹점 이용약관 전문', SYSTIMESTAMP);
